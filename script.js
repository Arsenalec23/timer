function updateCountdown() {
    ...
    var startDate = new Date('2024-06-01T09:30:00').getTime();
    ...
    daysElement.innerHTML = daysElapsed;
    hoursElement.innerHTML = ('0' + hoursElapsed).slice(-2);
    minutesElement.innerHTML = ('0' + minutesElapsed).slice(-2);
    secondsElement.innerHTML = ('0' + secondsElapsed).slice(-2);
}
